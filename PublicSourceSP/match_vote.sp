...
public OnPluginStart()
{
	...
	g_hMaxPlayers = CreateConVar("mv_maxplayers", "20", "How many slots would you like the Server to be at Config Load/Unload?");
...
StartResetMatchVote(client)
{
	...
	if (IsNewBuiltinVoteAllowed())
	{
		...
		{
			PrintToChat(client, "Resetmatch vote cannot be started. Players are connecting");
			return;
		}
		g_hVote = CreateBuiltinVote(VoteActionHandler, BuiltinVoteType_Custom_YesNo, BuiltinVoteAction_Cancel | BuiltinVoteAction_VoteEnd | BuiltinVoteAction_End);
